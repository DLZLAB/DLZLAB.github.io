window.SettingsPage = (function () {
  ...
  function render(container) {
    ...
    container.innerHTML =
      '<div class="page-head"><div><h2>Settings</h2><div class="page-head-sub">FlowOS v1.0 · ' + (online ? 'Online' : 'Offline mode') + '</div></div></div>' +
      ...
      '<div class="glass set-card">' +
      '<div class="set-head"><span class="set-ic">' + Icons.get('info') + '</span><div><h3>About &amp; PWA</h3><p>FlowOS — your personal productivity OS</p></div></div>' +
  ...
  const actions = {
    ...
    'pin-remove': async function () {
      const ok = await UI.confirm({
        ...
        message: 'Anyone who opens FlowOS on this device will have full access to its contents.',
